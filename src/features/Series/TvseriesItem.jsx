...
function TvseriesItem({ movie }) {
  const bookmarks = useSelector((state) => state.allMovies.bookmarks);

  // Determine if the movie is bookmarked by checking if it exists in the bookmarks array
  ...
  return (
    <div className="relative p-2 text-secondary">
      <div
        className="bg-cover bg-center h-[160px]  gap-8 inset-0 bg-gradient-to-r from-black to-transparent rounded-md  group relative cursor-pointer p-2"
        style={{
